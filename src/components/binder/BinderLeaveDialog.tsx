      ...
      <DialogContent className="max-w-md">
        ...
        <DialogFooter className="mt-4 flex gap-2 sm:justify-end sm:space-x-0">
          ...
          <button
            ...
            className="rounded-full border border-red-400 bg-red-500 px-4 py-2 text-sm font-nunito font-medium text-white transition hover:bg-red-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:border-accent dark:border-red-400 dark:bg-red-600 dark:hover:bg-red-500">
