  ...
  return (
    <div className="flex h-full items-start justify-center px-3 pt-2">
      <div className="w-full max-w-xl rounded-xl border border-zinc-300 bg-gray-50 p-4 shadow-lg dark:border-zinc-500 dark:bg-zinc-900/25">
        <h2 className="text-base font-nunito font-semibold text-zinc-700 dark:text-slate-100">
          Mobile Mode
        </h2>
        <p className="mt-1 text-xs font-nunito text-zinc-600 dark:text-zinc-300">
        ...
        <div className="mt-4 flex items-center justify-end gap-2">
          ...
          <button
            ...
            <span className="absolute -right-1 -top-1 z-20 flex h-4 min-w-4 items-center justify-center rounded-full bg-orange-500 px-1 text-[9px] font-nunito font-semibold leading-none text-white">
              {bulkBoxCount}
            </span>
