  ...
  return (
    <section className="mx-auto w-full max-w-4xl px-4 py-10 font-exo text-zinc-700 dark:text-slate-100">
      ...
      <div className="mt-6 space-y-6 text-sm leading-7">
        <p>
          This Privacy Policy explains how PokeBinder (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>Binder and collection data you create, upload, or organize in the app.</li>
            <li>Usage data, such as interactions, pages viewed, device/browser metadata, and approximate diagnostics.</li>
            <li>Technical data, such as IP address, timestamps, log data, and cookies/local storage identifiers.</li>
            <li>Communications you send us (support emails, feedback, reports).</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>Service providers and infrastructure vendors that support app operations.</li>
            <li>Authentication providers you use to sign in (for example, Google OAuth).</li>
            <li>Legal authorities where required by law, regulation, or valid legal process.</li>
            <li>Successors in connection with a merger, acquisition, financing, or asset sale.</li>
          </ul>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            To exercise rights, contact us at: <a className="underline" href="mailto:sam.nunn91+binder-app@gmail.com">sam.nunn91+binder-app@gmail.com</a>
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold">9. California Privacy Notice</h2>
          <p className="mt-2">
            California residents may have rights under California privacy laws,
            including rights to know, delete, correct, and limit use of sensitive
            personal information where applicable. We do not discriminate against
            users for exercising valid privacy rights.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold">10. Canada and Ontario Privacy Notice</h2>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            <a className="underline" href="mailto:sam.nunn91+binder-app@gmail.com">
              sam.nunn91+binder-app@gmail.com
            </a>
        ...
        <section>
          <h2 className="text-xl font-semibold">12. Marketing Communications (Canada CASL)</h2>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            The service is not directed to children under 13 (or higher age where
            required by local law). If you believe a child provided personal data,
            contact us so we can remove it.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold">15. Third-Party Links and Content</h2>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            will be posted with an updated &quot;Last updated&quot; date.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Privacy questions: <a className="underline" href="mailto:sam.nunn91+binder-app@gmail.com">sam.nunn91+binder-app@gmail.com</a>
          </p>
          <p>
            General support: <a className="underline" href="mailto:sam.nunn91+binder-app@gmail.com">sam.nunn91+binder-app@gmail.com</a>
          </p>
          <p>
            Privacy Officer: <a className="underline" href="mailto:sam.nunn91+binder-app@gmail.com">sam.nunn91+binder-app@gmail.com</a>
          </p>
          <p>
