            ...
            {({ isValid, dirty }) => (
              <Form className="space-y-4 p-4 text-left">
                <div>
                  <label
                    htmlFor="binder-name"
                    className="mb-2 block text-sm font-nunito font-medium text-zinc-700 dark:text-slate-100">
                    Name
                  </label>
                  <Field
                    id="binder-name"
                ...
                {createError ? (
                  <p className="text-sm font-nunito font-medium text-red-400">
                    {createError}
                  </p>
                ) : null}
                ...
                <DialogFooter className="border-t border-zinc-200 px-0 pt-4 sm:justify-end dark:border-zinc-800">
                  ...
                  <button
                    ...
                    className="rounded-full border border-accent bg-accent px-4 py-2 text-sm font-nunito font-medium text-white transition hover:bg-accent/90 disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:border-accent">
